...
<!-- badges: start -->
[![R-CMD-check](https://github.com/UofUEpi/BackPropNN/workflows/R-CMD-check/badge.svg)](https://github.com/UofUEpi/BackPropNN/actions)
<!-- badges: end -->
...
```{r example}
library(BackPropNN)
data <- data.frame(X1=sample(c(0,1),num_obs, replace = TRUE),
                   X2=sample(c(0,1),num_obs, replace = TRUE),
                   Y=ifelse(X1==0 & X2==0, 0, 1)) # Setting up the data
